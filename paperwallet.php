...
<div style="margin:0px; 
  ...
  " >
    ...
    <iframe src="https://produlz.com.br/apps/paperwallet/qrcode.php?data=<?php echo $address_1; ?>&level=H&imageWidth=200&size=10" 
        style="position: absolute; width: 200px; height: 200px;  top: 160px;  left: 47px; border:0px; margin:0px " scrolling="no" class="correct"></iframe>

        <iframe src="https://produlz.com.br/apps/paperwallet/qrcode.php?data=<?php echo $zpub_1; ?>&level=M&imageWidth=200" 
        style="width: 250px; height: 250px; position: absolute;  top: 123px;  left: 908px; border:0px; margin:0px" scrolling="no"></iframe>

        <iframe src="https://produlz.com.br/apps/paperwallet/qrcode.php?data=<?php echo $bip39_1; ?>&level=Q&imageWidth=200" 
        style="width: 250px; height: 250px; position: absolute;  top: 123px;  left: 1222px; border:0px; margin:0px " scrolling="no"></iframe>



    <div contenteditable="true" style="position: absolute;  top: 410px;  left: 85px; font-size: 15px; font-weight: 700;">
    <?php echo $address_1; ?>
    </div>
    ...
    <div contenteditable="true" style="position: absolute;  
    top: 378px;  
    left: 920px;   font-size: 11px; width: 550px; font-weight: 700;">
...
<div style="border: 0px solid #999;  width: 1700px; position: relative; ">
    <div style="border: 0px solid #999; width: 700px; padding-left:55px; padding-right:25px; padding-top:0px; float:left; margin-right:10px; height: 615px;">
...
<div style="border: 0px solid #999;  width: 700px; float:left; padding-left:25px; padding-right:25px;  height: 615px;" >
...
<div style="border: 1px solid #333; width: 100px; float:left; text-align:center; margin-left:5px;">
...
<div style="clear:both"></div>
<div style="margin-top:25px"> Pronto! Sua carteira de <b>Bitcoin Segwit</b> está pronta para ser utilizada. 
<br><br>Acumule SATs, experimente a rede relâmpago e <em>economize para o futuro</em>!<br><br></div>
...
<div style="border: 0px solid #999; margin-top:-45px" >
 <div style="border:0px; margin-left:30px; height: 515px; background-image: url('img/fundo_teste.jpg'); background-repeat: no-repeat;  background-size: contain;  width: 1515px; position:relative"  >
...
<iframe src="https://produlz.com.br/apps/paperwallet/qrcode.php?data=<?php echo $address_1; ?>&level=H" 
        style="width: 220px; height: 240px;  top: 60px; left: 90px; border:0px; margin-bottom:-25px; margin-top:-20px " scrolling="no"></iframe> 
Autenticidade da carteira
</div>


 <div style="float:left; width:260px; text-align: center;">
<iframe src="https://produlz.com.br/apps/paperwallet/qrcode.php?data=https://github.com/PraiaBitcoin/PBPaperWallet/&level=H" 
...
<div style="float:left; width:220px; text-align: center;">
<iframe src="https://produlz.com.br/apps/paperwallet/qrcode.php?data=https://mempool.space/pt/address/<?php echo $address_1; ?>&level=H" 
style="width: 220px; height: 240px;  top: 60px;  left: 35px; border:0px; margin:0px; margin-bottom:-25px; margin-top:-20px  " scrolling="no"></iframe> 
...
<div style="clear:both; "></div>
<div style="border: 0px solid #999;  width: 1700px; position: relative; margin-top:20px ">
    <div style="border: 0px solid #999; width: 710px; padding-left:50px; padding-right:25px; padding-top:0px; float:left; margin-right:10px; height: 500px;">
        ...
        <p style="margin:0px; padding-bottom:15px">Bitcoin é poder e liberdade para as pessoas, atrai clientes e também serve como forma de protesto às políticas monetárias. Considere-o como uma alternativa segura ao sistema financeiro tradicional em caso de confisco.</p>
        ...
        <p style="margin:0px; padding-bottom:15px">Prefira escrevê-las e guardá-las offline em um local seguro ou em um gerenciador de senhas criptografado.  Evite ao máximo salvar as palavras sementes no celular ou na nuvem. 
    ...
    <div style="border: 0px solid #999;  width: 700px; float:left; padding-left:25px; padding-right:25px;  height: 500px;" >
    ...
    <h3 style="margin:0px">Por que aprender comprar, receber e guardar bitcoin?</h3>
        ...
        <p style="margin:0px; padding-bottom:15px">Pensar no Bitcoin como uma poupança, comprando pequenas quantias mensalmente, independentemente do valor é uma excelente estratégia para iniciantes. </p>

        <h3 style="margin:0px">O que é <b>Lightning Network</b>?</h3>
        <p style="margin:0px; padding-bottom:15px">Nas transações através da Lightning Network, em Português, Rede Relâmpago, conhecida como segunda camada do protocolo, as pessoas enviam bitcoin de um lado para outro sem a necessidade de esperar que cada transação seja incluída em um bloco de Bitcoin. A lightning pode ser comparada com a conta corrente do banco e o futuro das transações diárias em bitcoin.</p>
